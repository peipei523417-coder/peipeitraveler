  ...
  return (
    <Dialog open={open} onOpenChange={(v) => { if (!loading) onOpenChange(v); }}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle className="text-center text-xl">Start Your Journey</DialogTitle>
        </DialogHeader>
        ...
        <p className="text-xs text-center text-muted-foreground pt-4">
          After signing in, projects you create are linked to your account and only you can edit them.
        </p>
      </DialogContent>
    </Dialog>
  );
